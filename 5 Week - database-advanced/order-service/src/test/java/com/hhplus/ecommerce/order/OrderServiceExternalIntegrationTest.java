...
public class OrderServiceExternalIntegrationTest {
    ...
    private void setupMockBehaviors() {
        ...
        // product port - 에어팟
        ProductFeignAdapter.ProductDto airpodsDto = new ProductFeignAdapter.ProductDto();
        airpodsDto.setId(4L);
        ...
        // product port - 아이폰
        ProductFeignAdapter.ProductDto iphoneDto = new ProductFeignAdapter.ProductDto();
        iphoneDto.setId(1L);
